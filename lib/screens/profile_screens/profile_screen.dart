...
Future<void> _logout() async {
  ...
  void _switchFarm(String farmId, String farmName) async {
    ...
    if (result == true && mounted) {
      // Update the provider — this triggers rebuild of all screens
  ...
  Widget build(BuildContext context) {
    ...
    // Watch provider — rebuilds when farm switches
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.manrope(
                            ...
                            fontWeight: FontWeight.w800,
                            letterSpacing: 1.2,
                            color: ProfileScreen.textGray.withOpacity(0.5),
                          ),
                        ),
                        ...
                        Text(
                          ...
                          style: GoogleFonts.manrope(
                            fontSize: 12,
                            color: ProfileScreen.textGray.withOpacity(0.4),
                          ),
                        ),
                      ],
                    ),
